...
protocol ElectronicsActionCellDelegate: class {
    func didTapLikeButton(_ likeButton: UIButton, on cell: ElectronicsActionCell)
}

class ElectronicsActionCell: UITableViewCell{
    ...
    weak var delegate: ElectronicsActionCellDelegate?
